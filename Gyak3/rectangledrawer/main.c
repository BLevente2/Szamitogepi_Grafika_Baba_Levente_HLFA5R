...
#define MAX_RECTANGLE_COUNT 100
...
int main(int argc, char *argv[]) {
    ...
    SDL_Window *window = SDL_CreateWindow("Rectangle Drawer", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_SHOWN);
    if (!window) {
                ...
                if (index != -1) {
                    ...
                    if (clickCount == 0) {
                        ...
                        if (rectangleCount < MAX_RECTANGLE_COUNT) {
                            ...
                            rectangles[rectangleCount++] = createRectangle(tempStart, end, currentColor);
                        }
                        clickCount = 0;
                    }
                }
