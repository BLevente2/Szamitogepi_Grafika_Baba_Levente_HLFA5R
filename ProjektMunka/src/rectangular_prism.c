...
void set_rectangular_prism_color(RectangularPrism* p,Color c){ p->color=c; }
void set_rectangular_prism_rotation(RectangularPrism* p,float rot){ p->rotationY=rot; }
